...
class CodeGenerator():
    ...
    # TODO(jiachen): finish this trash
    def generate_code(self):
        ...
        # write the C++ code to print out the readin array
        # self.write_line('std::cout << "Input tensor: " << std::endl;')
        # self.write_line('for (int i = 0; i < n; i++) {')
        # self.indents = 2
        # self.write_line(f'std::cout << {host_input_name}[i] << " ";')
        # self.indents = 1
        # self.write_line('}')
        ...
        for i in range(len(self.execution_order)):
            ...
            # print(f'Kernel{kernel_name} Inputs: {["device_" + input_tensor.name for input_tensor in input_list]}')
